...
@WebServlet(name = "RemoveSongPlaylistServlet", urlPatterns = {"/playlist/remove-song", "/remove-song-playlist"})
public class RemoveSongPlaylistServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean removed = playlistDAO.removeSong(playlistId, songId, userId);
        if (!removed) {
